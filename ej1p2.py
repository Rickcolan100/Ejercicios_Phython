...
print('Lineas donde aparecen los protocolos HTTTP e HTTPS') #1
lineas = texto.splitlines() #divide el texto en lineas
for elemento in lineas:
    if (protocolo_1 in elemento) or (protocolo_2 in elemento):
       print(elemento) 

print('Palabras mas comunes: ') #2
palabras = texto.split()
print(Counter(palabras).most_common(10))

letra = input('Ingrese una letra: ').lower()  #3
if not(letra in ascii_letters):
    print('LA LETRA NO EXISTE')
else:
    print(f'PALABRAS EN EL TEXTO DONDE ESTA LA LETRA {letra}: ')
